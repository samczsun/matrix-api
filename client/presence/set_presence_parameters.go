...
func (o *SetPresenceParams) WithPresenceState(presenceState SetPresenceBody) *SetPresenceParams {
	o.SetPresenceState(presenceState)
	return o
}

// SetPresenceState adds the presenceState to the set presence params
func (o *SetPresenceParams) SetPresenceState(presenceState SetPresenceBody) {
